Rails.application.routes.draw do
	# Send all incoming requests to our index file
	# and let angular handle them
	root 'application#index'

	# Got to define this for every resources
	# to let the browser play nicely with REFRESH page!
